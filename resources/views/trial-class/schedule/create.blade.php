                        ...
                        <div class="col-9">
                          ...
                          <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item" aria-current="page">Add Trial Class Schedules</li>
                            </ol>
                          </nav>
                        </div>
                        <div class="col-3">
                ...
                <div class="card w-100 position-relative overflow-hidden mb-0">
                  <div class="card-body p-4">
                    <div class="nav nav-pills mb-3 rounded align-items-center flex-row">
                        <h5 class="card-title fw-semibold">New Trial Class Schedule</h5>
                    ...
                    <form action="{{ route('trial-class-schedule.store') }}" method="POST">
                        @csrf
                    ...
                    @endif
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="number" name="age_from" value="{{old('age_from')}}" class="form-control" id="age_from" required>
                                @error('age_from')
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="number" name="age_to" value="{{old('age_to')}}" class="form-control" id="age_to" required>
                                @error('age_to')
                                    <div class="text-danger ">{{ $message }}</div>
                                @enderror
                              </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <select id="country" name="country" value="{{old('country')}}" title="other_data_country" class="form-control  select2" >
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="mb-4">
                            <label for="time" class="form-label fw-semibold"><i class="text-danger">* </i>Time</label>
                            <input type="time" name="time" value="{{old('time')}}" class="form-control" id="time" required>
                            @error('time')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                          </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                              ...
                              <select id="teacher_id" name="teacher_id" value="{{old('teacher_id')}}" class="form-control select2" required>
                      ...
                      <div class="row">
                            ...
                            <div class="mb-4">
                              ...
                              <select id="coordinator_id" name="coordinator_id" class="form-select select2">
                                  ...
                                  @foreach($customerSupportExecutives as $customerSupportExecutive)
                                    <option value="{{ $customerSupportExecutive->id }}">{{ $customerSupportExecutive->name }}</option>
                                  @endforeach
                              </select>
                            </div>
                          </div>
                        <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="number" name="available_seats" value="{{old('available_seats') ? old('available_seats') : '15'}}" class="form-control" id="available_seats">
