<x-parent-layout>
    <div class="pagetitle">
        <h1 class="text-left">{{!empty($new_session->classSession->sessionClass)? $new_session->classSession->sessionClass->name : 'Invalid Class'}}</h1>
    </div>
     ...
     <section>
       <div class="row">
         <div class="card col-md-4">
           <div class="card-body">
             <h5 class="card-title">{{ (!empty($new_session->classSession->sessionClass->name) ? $new_session->classSession->sessionClass->name : '') }}</h5>
