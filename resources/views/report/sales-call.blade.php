<x-dashboard.admin-layout>
    <x-slot name='title'>Sales Call Report - Dreamers Academy</x-slot>
    <!-- Main wrapper -->
                        ...
                        <div class="col-9">
                          ...
                          <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item" aria-current="page">Sales Call Report</li>
                            </ol>
                          </nav>
                        </div>
                        <div class="col-3">
                ...
                <div class="accordion-item" >
                    ...
                    <div id="collapse_search" class="accordion-collapse collapse" aria-labelledby="accordion_search" data-bs-parent="#accordion_filter">
                        <div class="accordion-body h-auto">
                          <form action="{{route('trial-class-sales-call-report')}}" method="get" >
                              <div class="row">
                                <div class="col-md-4">
            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive overflow-auto">
                  <table id="trial-class-sales-call-rpt-datatable" class="table border table-striped table-bordered display table-responsive">
                    <thead>
                      <tr>
                        <th scope="col">SL</th>
    ...
    <script src="{{asset('assets/js/reports/sales-call-1.0.0.js')}}"></script>
  </x-dashboard.admin-layout>
