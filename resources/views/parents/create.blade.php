                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                      <div class="row align-items-center">
                        <div class="col-9">
                          <h4 class="fw-semibold mb-8">New Parents</h4>
                          <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a class="text-muted" href="/">Home</a></li>
                              <li class="breadcrumb-item" aria-current="page">Add Parent</li>
                            </ol>
                          </nav>
                        </div>
                        <div class="col-3">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="mb-4">
                                ...
                                <input type="text" name="occupation" value="{{old('occupation')}}" class="form-control" id="occupation">
                                @error('occupation')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-4">
                              ...
                              <select id="country" name="country" value="{{old('country')}}" class="form-control select2">
