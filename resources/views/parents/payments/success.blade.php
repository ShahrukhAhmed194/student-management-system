...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " data-bs-target="#payment-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-currency-dollar"></i><span>Payments</span><i class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="payment-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    <li>
                    ...
                    <li>
                        <a class=" " href="/payment/fee">
                            <i class="bi bi-currency-dollar"></i>
                            <span>New Payment</span>
                        </a>
                    </li>
                    <!-- <li>
                        <a class=" " href="/trial-class-schedule">
                            <i class="bi bi-people"></i>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card text-center">
                        <div class="card-body mt-3 ">
                            <h5 class="card-title text-success">Your payment has been completed successfully.</h5>
