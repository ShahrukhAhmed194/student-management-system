...
<x-dashboard.admin-layout>
    ...
    <x-slot name='title'>Add Role - Dreamers Academy</x-slot>

    <div class="container-fluid">

        <x-inc.breadcrumb title="Add Role" />
                ...
                <form action="{{ route('roles.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter a Role Name" value="{{ old('name') }}" >
                                @error('name')
                                        ...
                                        <div class="row permission_block">
                                            @foreach($permissions as $permission)
                                                <div class="col-md-12 mb-2">
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input permission_check" type="checkbox" id="checkPermission{{ $permission->id }}" name="permissions[]" value="{{ $permission->name }}">
                    ...
                    <div class="card">
                        <div class="d-flex justify-content-between my-3 mx-2">
                            ...
                            <button type="submit" class="btn btn-primary float-right" id="studentsave_btn">Save</button>
                        </div>
                    </div>
                </form>
            </div>
