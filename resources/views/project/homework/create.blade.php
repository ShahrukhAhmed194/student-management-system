    ...
    <div class="body-wrapper">
        <div class="container-fluid">
                        ...
                        <div class="card-body px-4 py-3">
                            ...
                            <div class="col-9">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item" aria-current="page">Add Homework</li>
                                </ol>
                                </nav>
                            </div>
                            <div class="col-3">
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="card">
                          <h4 class="m-4">Homework Details</h4>
                        <form action="/homework-create" method="GET">
                            <div class="card-body">
                              <div class="row">
                                <div class="col-md-12">
                            ...
                            <table class="table datatable">
                                ...
                                @if ($count == 0)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="assesments[{{ $key}}][project_status]" name="assesments[{{ $key}}][project_status]" class="form-select">
                                        ...
                                        <td>
                                            <select id="assesments[{{ $key}}][project_assesment]" name="assesments[{{ $key}}][project_assesment]" class="form-select">
                                                <option disabled selected>- Please Select -</option>
                                ...
                                @else
                                    @foreach($students as $key=>$student)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check">
                                                    <textarea class="form-control" name="assesments[{{ $key}}][comments]" rows="5">{{$student->comments}}</textarea>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
