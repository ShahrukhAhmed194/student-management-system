                            ...
                            <div class="card-body px-4 py-3">
                                ...
                                <div class="col-9">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item" aria-current="page">Project Assessment</li>
                                    </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="card ">
                            <div class="">
                                @if(auth('web')->user()->can('projectassesment.add'))
                                    <a href="/project-assesment/create" class="btn btn-primary float-end m-3 align-items-center px-3" id="add-new">
                                    ...
                                    <tbody>
                                        @foreach($assesments as $assesment)
                                            <tr>
                                                ...
                                                <td>{{ $assesment->project->name }}</td>
                                                <td>{{ $assesment->student->name }}</td>
                                                <td>{{ str_replace("_"," ", $assesment->project_status) }}</td>
                                                <td>{{ str_replace("_"," ", $assesment->project_assesment) }}</td>
                                                <td>{{ $assesment->comments }}</td>
                                                @can('projectassesment.edit')
                                                    <td>
                                                        <a href="/project-assesment/{{$assesment->id}}/edit" class="text-info edit">
